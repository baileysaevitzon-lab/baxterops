"use client";
// Sprint 23: Managerial Recertification Doc — simplified workflow route.
// Reuses the existing manager completion form (CompletionFormView).
// Route: /recertification/[caseId]/manager-doc
